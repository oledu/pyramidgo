...
/**
 * Castle4 組件 - 使用 Canvas 實現多層 PNG 圖片重疊效果，使用 castle_bg5.png
 * @param {Object} data - 數據物件
 * @param {string} period - 當前時期
 */
const Castle4 = ({ data, period, scoresNoLimitsGymDate }) => {
  if (period < '202504T') {
    return null;
  }
        ...
        >
          <div className="bg-gray-900 border-2 border-red-800 rounded-lg p-6 max-w-md w-11/12 text-center relative max-h-[80vh] overflow-y-auto">
            ...
            <div className="mb-4 flex justify-center">
              <p></p>
              <img
                src={selectedCastle.isGhost ? "/ghost_castle.png" : "/castle.png"}
